...
>
	<div class="m-3 flex flex-col space-y-4 text-sm leading-relaxed">
		<h3 class="text-muted-foreground text-xl font-semibold">Understanding</h3>
		...
		<ul class="flex flex-col gap-y-2 text-sm">
			...
			<li class="text-muted-foreground text-pretty">
				...
				monitors about 500 major german train stations daily. If an "inactive" journey is spotted appearing on a station
				timetable again, the system instantly flips its status back to <strong>active</strong> and resumes tracking.
			</li>
		</ul>
	</div>
</Dialog>
