<script module lang="ts">
	...
	const validTypes: ValidType[] = [
		{ key: MetricSeriesType.GLOBAL_STOP_ARRIVALS, title: "Arrivals" },
		{ key: MetricSeriesType.GLOBAL_STOP_DEPARTURES, title: "Departures" }
	];
...
<script lang="ts">
	import type { BaseMetricDataPoint, BaseMetricDataPointTimestampTransportTypeMetricDataPoint, MetricSeries } from "@lib/api";
