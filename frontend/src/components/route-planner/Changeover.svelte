...
<div class="flex min-h-32 flex-row text-base">
	<span class="text-text/65 basis-1/5 self-center text-right">{formatDuration(departure, arrival)}</span>
	...
	<span class="flex basis-3/5 items-center self-center">
