	...
	<div class="px-4 space-y-2" class:opacity-65={isCancelled}>
		...
		<div class="accent-scrollbar flex w-full flex-row gap-x-2 overflow-x-auto">
			{#each route?.legs.filter((leg) => !leg?.walking) as leg}
				<span
					class="bg-primary/25 min-w-fit truncate rounded-lg px-2 py-1 text-center text-base md:text-lg font-medium"
		...
		<div class="flex justify-center">
			<button class="flex cursor-pointer flex-row items-center gap-x-2"
