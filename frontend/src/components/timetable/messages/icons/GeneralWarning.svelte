...
<svg id="general-warning" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" {height} {width} class={"shrink-0"}>
	<g id="general-warning">
		<rect class="cls-1" x="-88.14" y="-111.88" width="1215.3" height="1262.77" />
		<path
			class="cls-2"
