...
public class StationEventQualityTimeSeriesMetricRequest : BaseMetricRequest, IEvaNumberMetricRequest
{
    ...
    [Description("The station-event quality metric to retrieve as a station-level time series.")]
