...
const NormalRouteSectionSchema = t.Object({
	hafas_journeyId: t.String({ description: "Identifier for the journey in the HAFAS system. Optional when `section` is set to true." }),
...
const RouteEntrySchema = t.Object({
	...
	sections: t.Array(t.Union([NormalRouteSectionSchema, WalkingRouteSectionSchema]), { description: "Array of route sections" }),
...
export { OccupancySchema, RouteMessageSchema, BasicRouteStopSchema, ExtendedRouteStopSchema, WalkingRouteSectionSchema, RouteJourneyAttributeSchema, NormalRouteSectionSchema, RouteEntrySchema, RouteDetailsSchema };