...
public class RisIdSnapshotMetricRequest : BaseMetricRequest
{
    ...
    public override Navigator.Data.Models.Statistics.BaseMetricRequest BuildRequest() => new Navigator.Data.Models.Statistics.Request.RisIdSnapshotMetricRequest()
    {
        Start = Start,
        End = End
    };
