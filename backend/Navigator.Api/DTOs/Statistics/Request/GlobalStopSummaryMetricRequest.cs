...
public class GlobalStopSummaryMetricRequest : BaseMetricRequest
{
    ...
    public override Navigator.Data.Models.Statistics.BaseMetricRequest BuildRequest() => new Navigator.Data.Models.Statistics.Request.GlobalStopSummaryMetricRequest()
    {
        Start = Start,
        End = End,
