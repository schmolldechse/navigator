...
const ITrackChanged = ({width = 25, height = 25}: Props) => {
    return (
        ...
        >
            ...
            <g>
                <polygon fillRule={"evenodd"} fill={"#0a0a0a"}
                         points="166.63 692.78 166.63 649.88 244.01 649.88 265.55 692.96 166.63 692.78"/>
                <polygon fillRule={"evenodd"} fill={"#0a0a0a"}
                         points="308.64 649.88 330.18 692.96 437.9 692.96 416.35 649.88 308.64 649.88"/>
                <polygon fillRule={"evenodd"} fill={"#0a0a0a"}
                         points="502.53 305.18 480.98 262.1 588.7 262.1 610.24 305.18 502.53 305.18"/>
                <polygon fillRule={"evenodd"} fill={"#0a0a0a"}
                         points="674.87 305.18 653.33 262.1 761.05 262.1 782.59 305.18 674.87 305.18"/>
                <path fill={"#0a0a0a"}
